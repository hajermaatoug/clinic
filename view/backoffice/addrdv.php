...
if (
    ...
    if (
        ...
        $rendezvousC->create($rendezvous);
    } else {
        $error = "Missing appointment date or reason";
    }
}
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Creer Rendez vous</h1>
                    ...
                    <div class="row">
                        <form action="" id="formRendezVous" method="post">
                            ...
                            <a href="rdv.php" class="btn btn-success">List Rendez-vous</a>
                        </form>
